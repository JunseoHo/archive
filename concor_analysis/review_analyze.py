...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
# Komoran 사용자 사전 경로
KOMORAN_USER_DICT = "./komoran_user.dict.txt"
...
def analyze(profiles):
    ...
    with open("matrix/tf.csv", mode='w', encoding='utf-8') as outfile:
        # csv 파일 헤더 작성
    ...
    with open("matrix/tf_idf.csv", mode='w', encoding='utf-8') as outfile:
        # csv 파일 헤더 작성
    ...
    # CSV 파일로 저장
    word_matrix.to_csv("matrix/co_occur.csv")
