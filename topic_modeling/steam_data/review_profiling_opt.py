...
# PRE_REPLACE = [('로그라이트', '로그라이크'), ('로그라이크', 'Roguelike'), ('유저', 'User'), ('스킬', 'Skill'), ('체크포인트', 'Checkpoint'),
#                ('캐릭', '캐릭터'), ('얼리엑세스', 'EarlyAccess'), ('얼엑', 'EarlyAccess'), ('얼액', 'EarlyAccess')]
#
# POST_REPLACE = [('재밌', '재미'), ('재미없', '재미'), ('느끼', '느낌'), ('타임', '시간'), ('이야기', '스토리'), ('지역', '스테이지'),
#                 ('야가다', '노가다'), ('업뎃', '업데이트'), ('패치', '업데이트'), ('콘텐츠', '컨텐츠'), ('짱깨', '중국인'), ('제작자', '개발자'),
#                 ('세이브', '저장'), ('피해', '데미지'), ('컨트롤', '조작'), ('구입', '구매'), ('즉사', '사망'), ('싸움', '전투'),
#                 ('맵', '스테이지'), ('끝', '마지막'), ('방', '스테이지'), ('길', '스테이지'), ('스포', '스포일러'), ('재화', '자원'), ('만들', '제작'),
#                 ('사용자', '플레이어'), ('User', '플레이어'), ('탐사', '탐험'), ('Skill', '기술'), ('개발사', '개발자'), ('Checkpoint', '세이브'),
#                 ('총기', '무기'), ('세일', '할인'), ('움직임', '모션'), ('세계', '월드'), ('건축', '건설'), ('서바이벌', '생존'), ('어택', '공격')]
